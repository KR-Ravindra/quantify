...
BIGQUERY_DATASET = os.environ.get('BIGQUERY_DATASET', 'quantify_stg')
...
with DAG(
    dag_id = f'quantify_dag',
    default_args = default_args,
    description = f'Hourly data pipeline to generate dims and facts for quantify',
